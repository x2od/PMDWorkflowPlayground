...
if [ "$continue" = "y" ]; then
	...
	sf project deploy start --source-dir force-app/unmanagedExtension --target-org PackageInstallTest

	echo "Assigning permission set"
	sf org assign permset --name ChangeMe --target-org PackageInstallTest
